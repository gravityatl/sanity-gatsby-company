...
export const query = graphql`
  query OfferPageQuery {
    page: sanityPage(_id: { regex: "/(drafts.|)offer/" }) {
      id
      title
      _rawBody
    }
...
const OfferPage = props => {
  ...
  if (!page) {
    throw new Error(
      'Missing "Offer" page data. Open the studio at http://localhost:3333 and add "Offer" page data and restart the development server.'
    )
  }
